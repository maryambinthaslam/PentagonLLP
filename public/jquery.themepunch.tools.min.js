      ...
      var h,
        ...
        Q = (E.convertToPixels = function (t, i, r, s, n) {
          ...
          if ((_ && (r = -r), "%" === s && -1 !== i.indexOf("border")))
            ...
            f.appendChild(z),
              (o = parseFloat(z[u ? "offsetWidth" : "offsetHeight"])),
              f.removeChild(z),
              u &&
                "%" === s &&
                a.cacheWidths !== !1 &&
        ...
        G = (E.calculateOffset = function (t, e, i) {
          ...
          var r = "left" === e ? "Left" : "Top",
            s = H(t, "margin" + r, i);
          return (
            t["offset" + r] - (Q(t, e, parseFloat(s), s.replace(y, "")) || 0)
          );
        }),
        Z = function (t, e) {
          var i,
      ...
      var ve =
        ...
        Pe = (E.getTransform = function (t, e, i, r) {
          ...
          var s,
            ...
            b = w * M,
            P = we
              ? parseFloat(H(t, xe, e, !1, "0 0 0").split(" ")[2]) ||
                v.zOrigin ||
                0
              : 0;
          if (
            ...
            if (16 === n.length) {
              ...
              if (
                ...
                (v.rotationX = $ * L),
                  ...
                  Y && K
                    ...
                    : F && K && (v.rotationY = v.rotationX = 0),
                  (v.scaleX = (0 | (Math.sqrt(B * B + U * U) * x + 0.5)) / x),
                  (v.scaleY = (0 | (Math.sqrt(q * q + k * k) * x + 0.5)) / x),
                  (v.scaleZ = (0 | (Math.sqrt(Q * Q + R * R) * x + 0.5)) / x),
                  (v.skewX = 0),
              ...
              (v.x = n[4] || 0),
                ...
                (f = Math.sqrt(re * re + ie * ie)),
                (p = te || ee ? Math.atan2(ee, te) * L : v.rotation || 0),
                (_ = ie || re ? Math.atan2(ie, re) * L + p : v.skewX || 0),
        ...
        ke = (E.set3DTransformRatio = function (t) {
          ...
          if (p) {
            ...
            z > C && C > -z && (C = O = 2e-5),
              z > A && A > -z && (A = O = 2e-5),
              !X || S.z || S.rotationX || S.rotationY || (X = 0);
          }
          if (R || S.skewX)
            (y = Math.cos(R)),
              (T = Math.sin(R)),
          ...
          (f = 1),
            ...
            (s = (x = (s += D) - (s |= 0))
              ? (0 | (x * v + (0 > x ? -0.5 : 0.5))) / v + s
              : s),
            (l = (x = (l += L) - (l |= 0))
              ? (0 | (x * v + (0 > x ? -0.5 : 0.5))) / v + l
              : l),
            (_ = (x = (_ += N) - (_ |= 0))
              ? (0 | (x * v + (0 > x ? -0.5 : 0.5))) / v + _
              : _),
            (k[ye] =
              (S.xPercent || S.yPercent
        ...
        "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent",
        {
          parser: function (t, e, i, r, n, o, l) {
            ...
            if ("string" == typeof T.transform && ye)
              ...
              "string" == typeof T.x &&
                -1 !== T.x.indexOf("%") &&
                ((h.x = 0), (h.xPercent = re(T.x, m.xPercent))),
                "string" == typeof T.y &&
                  -1 !== T.y.indexOf("%") &&
                  ((h.y = 0), (h.yPercent = re(T.y, m.yPercent))),
                (h.rotation = se(
                  "rotation" in T
                    ? T.rotation
                    : "shortRotation" in T
